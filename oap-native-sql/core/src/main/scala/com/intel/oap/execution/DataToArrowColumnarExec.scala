 ...
 */
case class DataToArrowColumnarExec(child: SparkPlan, inputPartitioning: Partitioning)
    extends UnaryExecNode {
  override def output: Seq[Attribute] = child.output

  override def outputPartitioning: Partitioning = inputPartitioning
  ...
  override def doExecuteColumnar(): RDD[ColumnarBatch] = {
    ...
    BroadcastColumnarRDD(sparkContext, metrics, outputPartitioning.numPartitions, inputByteBuf)
  }
